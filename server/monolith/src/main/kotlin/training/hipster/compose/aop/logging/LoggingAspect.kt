package training.hipster.compose.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(training.hipster.compose.repository..*)" +
            " || within(training.hipster.compose.service..*)" +
            " || within(training.hipster.compose.web.rest..*)"
    )
